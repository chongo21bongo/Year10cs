...
public class Badguy {
	...
	public Badguy(int x, int y, int w, int h, String imgpath) {
	 ...
	 public void RePosition() { //  re-randomizes positions of bad guys
		...
		// System.out.println("score winwidth " + String.valueOf(winwidth));
		// System.out.println("score winheight " + String.valueOf(winheight));
		
		setxCoord(rx);
		setyCoord(ry);
			
		// System.out.println("score rx = " + String.valueOf(rx));
		// System.out.println("score ry = " + String.valueOf(ry));
